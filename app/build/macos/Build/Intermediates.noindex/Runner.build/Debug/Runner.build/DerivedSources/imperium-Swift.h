...
#ifndef IMPERIUM_SWIFT_H
#define IMPERIUM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="imperium",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8imperium11AppDelegate")
...
SWIFT_CLASS("_TtC8imperium17MainFlutterWindow")
